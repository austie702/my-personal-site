        ...
        <section className="left-panel">
          ...
          <section className="left-panel-section">
            ...
            <div className="icon-link">
              ...
              <a href="https://www.artstation.com/austinhowes" target="blank" className="contact-info">Artstation</a>
            </div>
            <div className="icon-link">
              <div className="icon">
            ...
            <div className="icon-link">
              ...
              <a href="https://www.facebook.com/austin.howes" target="blank" className="contact-info">Facebook</a>
            </div>
            <div className="icon-link">
              <div className="icon">
                <FontAwesomeIcon icon={['fab', 'twitter']} />
              </div>
              <a href="https://twitter.com/austie702" target="blank" className="contact-info">Twitter</a>
            </div>
            <div className="icon-link">
              <div className="icon">
                <FontAwesomeIcon icon={['fab', 'linkedin']} />
              </div>
              <a href="https://www.linkedin.com/in/austinhowes/" target="blank" className="contact-info">austinhowes</a>
            </div>
            <div className="icon-link">
              <div className="icon">
                <FontAwesomeIcon icon={['fab', 'github']} />
              </div>
              <a href="https://github.com/austie702" target="blank" className="contact-info">Github</a>
            </div>
          </section>
